...
from bombanitio import special as specialx
import sys
...
def get_four(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    if type1 == 0 and type2 == 0 and type3 == 0 and type4 == 0:
        ...
        four = four_pppp(
            type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4
        )
        ...
        four = four_psss(
            type2, type1, type3, type4, exp2, exp1, exp3, exp4, r2, r1, r3, r4
        )
    elif type1 == 0 and type2 == 0 and type3 > 0 and type4 == 0:
        # four = four_psss(type3, type2, type1, type4,  exp3, exp2, exp1, exp4,  r3, r2, r1, r4)
        four = four_psss(
            type3, type4, type1, type2, exp3, exp4, exp1, exp2, r3, r4, r1, r2
        )
    elif type1 == 0 and type2 == 0 and type3 == 0 and type4 > 0:
        # four = four_psss(type4, type2, type3, type1,  exp4, exp2, exp3, exp1,  r4, r2, r3, r1)
        four = four_psss(
            type4, type3, type1, type2, exp4, exp3, exp1, exp2, r4, r3, r1, r2
        )
        ...
        four = four_psps(
            type1, type2, type4, type3, exp1, exp2, exp4, exp3, r1, r2, r4, r3
        )
    elif type1 == 0 and type2 > 0 and type3 == 0 and type4 > 0:
        four = four_psps(
            type2, type1, type4, type3, exp2, exp1, exp4, exp3, r2, r1, r4, r3
        )
        ...
        four = four_ppps(
            type4, type3, type2, type1, exp4, exp3, exp2, exp1, r4, r3, r2, r1
        )
...
def four_ssss(exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    rr = (exp1 * r1 + exp2 * r2) / (exp1 + exp2) - (exp3 * r3 + exp4 * r4) / (
        exp3 + exp4
    )
...
def four_psss(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    four = (
        ...
        * np.pi ** 3
        / (nu ** 2.5 * theta ** 1.5)
        * (q ** 2 * rr[i] * s2(t) - 2 * exp2 * (r1[i] - r2[i]) * s1(t))
    )
...
def four_ppss(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    four = (
        ...
        * (
            ...
            * (
                delta(i, j)
                + 2 * exp1 * (r1[j] - r2[j]) * rr[i]
                - 2 * exp2 * (r1[i] - r2[i]) * rr[j]
            )
            * s2(t)
            + (
                2 * nu * delta(i, j)
                - 4 * exp1 * exp2 * (r1[i] - r2[i]) * (r1[j] - r2[j])
            )
            * s1(t)
        )
    )
...
def four_psps(
    type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4, norm=True
):
    nu = exp1 + exp2
    theta = exp3 + exp4
    q = (nu * theta / (nu + theta)) ** 0.5
    ...
    four = (
        ...
        * (
            ...
            + q ** 2
            * (
                2 * exp2 * (r1[i] - r2[i]) * rr[k]
                - 2 * exp4 * (r3[k] - r4[k]) * rr[i]
                - delta(i, k)
            )
            * s2(t)
            + 4 * exp2 * exp4 * (r1[i] - r2[i]) * (r3[k] - r4[k]) * s1(t)
        )
    )
    if norm:
        four *= (128 * exp1 ** 5 / np.pi ** 3) ** 0.25
...
def u2(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    k = type3 - 1
    tmp = 2 * (
        2 * exp2 * exp4 * (r1[i] - r2[i]) * (r3[k] - r4[k]) * rr[j]
        + exp2 * (r1[i] - r2[i]) * delta(j, k)
        - nu * rr[k] * delta(i, j)
        - exp4 * (r3[k] - r4[k]) * delta(i, j)
    )
...
def u3(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    tmp = (
        2 * exp2 * (r1[i] - r2[i]) * rr[j] * rr[k]
        - 2 * exp4 * (r3[k] - r4[k]) * rr[i] * rr[j]
        - rr[k] * delta(i, j)
        - rr[i] * delta(j, k)
        - rr[j] * delta(i, k)
    )
...
def four_ppps(
    ...
    four = (
        ...
        * (r1[j] - r2[j])
        * four_psps(
            type1, 0, type3, 0, exp1, exp2, exp3, exp4, r1, r2, r3, r4, norm=False
        )
    )
    # print(four)
    four += (
        ...
        * (
            q ** 6
            * u4(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            * s4(t)
            + q ** 4
            * u3(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            * s3(t)
            + q ** 2
            * u2(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            * s2(t)
            + u1(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            * s1(t)
        )
    )
...
def v2(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    l = type4 - 1
    tmp = 2 * (
        (nu + theta) * delta(i, j) * delta(k, l)
        - 2 * exp2 * theta * (r1[i] - r2[i]) * rr[j] * delta(k, l)
        - 2 * exp2 * exp4 * (r1[i] - r2[i]) * (r3[k] - r4[k]) * delta(j, l)
    )
    return tmp
...
def v3(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    l = type4 - 1
    tmp = (
        2 * theta * rr[i] * rr[j] * delta(k, l)
        + 2 * exp4 * (r3[k] - r4[k]) * (rr[i] * delta(j, l) + rr[j] * delta(i, l))
        - 2 * exp2 * (r1[i] - r2[i]) * (rr[k] * delta(j, l) + rr[j] * delta(k, l))
        + delta(i, j) * delta(k, l)
        + delta(i, l) * delta(j, k)
        + delta(i, k) * delta(j, l)
    )
...
def four_pppp(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4):
    ...
    four = (
        ...
        * (r1[j] - r2[j])
        * four_ppps(
            type3, type4, type1, 0, exp3, exp4, exp1, exp2, r3, r4, r1, r2, norm=False
        )
    )
    four += (
        gab(exp1, exp2, r1, r2)
        ...
        * (
            ...
            * s5(t)
            + q ** 6
            * (
                v4(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
                + 2
                * exp3
                * (r3[l] - r4[l])
                * u4(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            ...
            * s4(t)
            + q ** 4
            * (
                v3(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
                + 2
                * exp3
                * (r3[l] - r4[l])
                * u3(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            ...
            * s3(t)
            + q ** 2
            * (
                v2(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
                + 2
                * exp3
                * (r3[l] - r4[l])
                * u2(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
            ...
            * s2(t)
            + (
                v1(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)
                + 2
                * exp3
                * (r3[l] - r4[l])
                * u1(type1, type2, type3, type4, exp1, exp2, exp3, exp4, r1, r2, r3, r4)

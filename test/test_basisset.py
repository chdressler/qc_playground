...
def test_orbitals():
    ...
    assert coef.astype('float64') == pytest.approx(np.array([0.1559162750E+00, 0.6076837186E+00, 0.3919573931E+00]))
    assert exp.astype('float64') == pytest.approx(np.array([0.1512182352E+02, 0.3513986579E+01, 0.1142857498E+01]))
...
def test_easy_read():
    ref_coord = np.array([[ 0.00000,    0.00000,     0.0000], 

...
def test_form_g_mat():
    ...
    orca_dens = np.loadtxt("../data/dens_xxx_03")
    orca_fock = np.loadtxt("../data/fock_xxx_03")
    orca_h = np.loadtxt("../data/h_xxx_03")
    ...
    coord, atom = read_xyz.easy_read("../data/coord_xxx_03.xyz", None, False, False)
    coord = coord[0,:,:]
